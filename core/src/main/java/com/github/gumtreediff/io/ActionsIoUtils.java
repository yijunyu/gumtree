...
public final class ActionsIoUtils {
    ...
    public static ActionSerializer toText(TreeContext sctx, List<Action> actions, MappingStore mappings)
            throws IOException {
    ...
    public static ActionSerializer toXml(TreeContext sctx, List<Action> actions, MappingStore mappings)
            throws IOException {
        return new ActionSerializer(sctx, mappings, actions) {
    ...
    public static ActionSerializer toJson(TreeContext sctx, List<Action> actions, MappingStore mappings)
            throws IOException {
        return new ActionSerializer(sctx, mappings, actions) {
        ...
        public void writeTo(Writer writer) throws Exception {
            ...
            if (update_pb) {
                ...
                if (dst != null) {
                    ...
                    if (dst_unit.getUnit() != null) {
                        ...
                        fast.Fast.Data.Builder data_element = fast.Fast.Data.newBuilder();
                        if (dst_unit != null)
                            data_element.setElement(dst_unit);
            ...
            for (Action a : actions) {
                ...
                if (a instanceof Move) {
                    ...
                    if (dst != null && dst.getParent() != null) {
